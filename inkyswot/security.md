...
The most immediate threat. Bad actors creating accounts
to abuse the AI prompt allowance.

FIRST LINE DEFENCES — LOCKED:
Paid only — no free tier. Mass account farming uneconomical.
14-day money back guarantee — transparent and fair.
Email verification code: unique, 20 min expiry,
max 3 requests, 3 failures = account lock + spam flag.
Publication fee: £1 GBP per publication — anti-scam friction.
