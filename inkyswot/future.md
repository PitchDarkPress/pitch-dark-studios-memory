...
what changed is written beside it, dated.
NEW: THE ILLUSTRATION LIBRARY — shared initials and illustrations, free to
subscribers. It was conceived the evening of the 16 September session,
after that session's write-up, so it reached no file until now.
CHANGED: the continuity library and the import have CONVERGED — the import
became a check. Where the 16 September text said the import "is being
built", read "is being worked out": nothing of it is built yet, and how
uploaded work is referenced is still open.

*** THE SUPABASE WORK IS SUBJECT TO CHANGE *** Kev, 22 September: "I have
no idea how things will work on Supabase and until then I can't nail
things down." Only the LIBRARY is moving to Supabase, and even that is
decided for now. Notes below that assume a server behind the whole
platform describe a direction, not the present.
...
layer.
UPDATED 22 SEPTEMBER — THE TWO HALVES HAVE MET. Kev corrected the import:
"We DONT need ALL that info, just the ability to check it … have it 'ping'
the user when they get things wrong in the new book — IE: hair colour
etc." And: character facts belong in the character cards, "there is no
point in rebuilding a character profile when it already exists." SO THE
IMPORT IS NOW, IN ESSENCE, THIS ENTRY'S CHECKING HALF. The fourth time the
same idea has arrived. "The front half of it is being built" above is too
strong: NOTHING IS BUILT YET, and Kev: "We will be still building on how
uploaded work is referenced." THE FACTUAL LAYER IT NEEDS is now written up
as inkyswot/factual-layer.md.
...
they do. ***
[CORRECTED 22 SEPTEMBER: "now being built" overstated it. Nothing of the
...
================================================================
THE ILLUSTRATION LIBRARY — shared initials and illustrations
Conceived the evening of the 16 September session, after its write-up.
Recorded 22 September. NOT STARTED.
================================================================

WHERE IT CAME FROM. The chapter-initials idea from the August clipart
conversation: black line-art dropped capitals, ornaments and section
dividers drawn as a library inside InkySwot. Subscriber-only, shown
publicly in a gallery but not downloadable without a subscription,
licensed for use in published books but not for passing the files on.
Parked with the rest of that conversation; this was the part that
survived, on the grounds that no competing writing platform offers it.

THEN KEV TOOK IT TWO STEPS FURTHER, THE SAME EVENING.
1. SHARING. "I create a set of initials, why can't I offer them to other
   users? The same with illustrations and so on." A library that one
   person fills is a slow trickle; one that its users fill fills itself,
   and is filled by the people who know what a chapter opening needs,
   because they are writing books too. It also gives a writer a reason to
   stay beyond the subscription itself.
2. GENERATED FROM THE BOOK. "The initials that I want to create can be
   generated by AI based on the text of the current book. It could offer
   3 or 4 styles to the user." An initial drawn from what the book is —
   brambles for a gothic, rigging for a sea story — is something a stock
   pack cannot do. Offering three or four keeps the writer choosing.

A MARKETPLACE WAS CONSIDERED, AND KEV SET IT ASIDE HIMSELF.
Claude named what selling brings: payments out to other people, tax,
disputes, refunds, and a takedown route. And a harder point specific to
AI-generated images: in the UK and the US they may not attract copyright
at all, which leaves it unclear what a seller would be selling or a buyer
buying. Worth a lawyer's ten minutes before any money changed hands.
Claude also pushed back on being the "least strict" option as a draw:
permissiveness pulls volume, and volume of low-effort work is what the
August research found sinking the big stock marketplaces.
KEV: "Then allow it all to be free. Still a draw. BUT only to InkySwot
subscribers." THAT DISSOLVES THE OWNERSHIP AND PAYMENTS PROBLEMS IN ONE
MOVE. What is left is a SHARING LIBRARY, not a shop — a much smaller
machine.

KEV'S POSITION ON DISCLOSURE, AND IT STANDS: "as long as we are upfront
about where the images/texts come from we will be fine." Declaring the
source settles the honesty question completely, and sits squarely inside
Proauthorism. It does not by itself settle ownership — which is exactly
why free-to-subscribers is the right cut.
AND HIS OBSERVATION about the big stock sites — that much of what they
carry is not human-only work, whatever the front page implies — was
probably right, though Claude did not check it and said so. The
consequence cuts the way Kev went: if the industry is quietly full of it,
declaring plainly is not the strict option but the honest one.

STILL OPEN:
· WHY A WRITER WOULD CONTRIBUTE, when nothing is paid. Credit is the
  likely answer: the contributor's name on the piece, a page of what they
  have made. That is worth something to an author in a way it is not to a
  stock illustrator.
· HOW SOMETHING GETS TAKEN DOWN. Not for money reasons now, but because
  sooner or later somebody uploads work that is not theirs. The platform
  needs a route that does not depend on Kev noticing.
...
[NOTE 22 SEPTEMBER: the six stages were Claude's outline, not a decision,
and the import's purpose has since become checking rather than filling.
The muster does stand, and is locked.]
...
nicety.
NOTE 22 SEPTEMBER: NOW WRITTEN UP, comprehensively at Kev's request, as
inkyswot/factual-layer.md — with a notes section on every record for
preferences and habits, which are checkable too. Three questions open in
it. A working list, not a lock.

PLATFORM — FUTURE PRODUCTS
Newspaper / magazine platform — separate product.
Rights marketplace — writers sell and license rights.
  NOTE 22 SEPTEMBER: THE ILLUSTRATION LIBRARY above is the same instinct
  aimed much nearer, and free rather than sold.
...
3. THE CONTINUITY LIBRARY — above. Its front half is being built.
   [22 SEPTEMBER: being worked out, not built — and it is now the same
   thing as the import, which became a check.]
...
A PAID MARKETPLACE FOR INITIALS AND ILLUSTRATIONS — considered the evening
of the 16 September session and set aside by Kev himself in favour of a
FREE SHARING LIBRARY for subscribers. Selling would have brought payments
out, tax, disputes, refunds, and the unresolved question of whether an
AI-generated image can be owned and therefore sold at all. KEV: "Then
allow it all to be free. Still a draw. BUT only to InkySwot subscribers."
Recorded here so a shop is not re-proposed without knowing why it was
turned down. See THE ILLUSTRATION LIBRARY above.